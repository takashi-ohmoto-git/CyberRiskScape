...
上部ツールバーの **Analytics** を開いてリスクを評価します。

リスク評価は 4 項目（損害・影響範囲・再現性・攻撃容易性）をそれぞれ 1〜3 で評価し、
Impact 軸（損害・影響範囲）と Likelihood 軸（再現性・攻撃容易性）の 2 軸マトリクスで
ランクへ変換する方式です（出典：
...
ルール由来の severity は一般論です。Analytics でリスクを評価すれば、
